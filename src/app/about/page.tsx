    ...
    <div className="min-h-screen bg-black text-white p-6 sm:p-10">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg mb-6">
          valaclava is more than a brand. We are a blend of technology, music, fashion, and speed, 
        ...
        <p>We believe in a future where technology fuels self-expression, where music moves with you, and where innovation is at the core of everything you wear and create. valaclava isn't just a name—it's a philosophy of movement, sound, and limitless potential.</p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li><strong>Creativity:</strong> valaclava is a space for creators, artists, and pioneers who challenge conventions.</li>
        ...
        <p>valaclava is built for the fearless, the pioneers, and the creators. Whether you push limits on the track, in the studio, or in your own unique space, we're here to fuel your passion. The future is now—let's synthesize it together.</p>

        <p className="mt-6">Follow us on <a href="https://x.com/valaclavahq">[X (@valaclavahq)]</a> and stay ahead of the curve.</p>
      </div>
    </div>
  );
};
